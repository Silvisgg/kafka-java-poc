...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -930929108485158503L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"com.example.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.schema.Employee.Builder newBuilder() {
    return new com.example.schema.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.example.schema.Employee.Builder newBuilder(com.example.schema.Employee.Builder other) {
    return new com.example.schema.Employee.Builder(other);
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.example.schema.Employee.Builder newBuilder(com.example.schema.Employee other) {
    return new com.example.schema.Employee.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.schema.Employee.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.schema.Employee other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schema.Employee.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schema.Employee.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schema.Employee.Builder setFirstName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schema.Employee.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schema.Employee.Builder setLastName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schema.Employee.Builder clearLastName() {
      lastName = null;
